                    ...
                    <div className="mx-auto w-3/4 flex flex-col items-center gap-3 overflow-y-auto no-scrollbar pb-10">
                        ...
                        <div className="flex sm:flex-row flex-col w-1/2 justify-between">
                            ...
                            {leavingSelector ? (
                                ...
                                >
                                    Leave All <FontAwesomeIcon icon={faXmark} />
                                </Button>
                            )}
                        </div>
                        ...
                        {queues.map((location) => {
                            return (
                                <LocationCard
                                    ...
                                    selected={
                                        selectedQueues[location.locationID]
                                    }
                                    setSelected={(bool) => {
                                        if (bool) {
                                            setSelectedQueues({
                                            ...
                                            const copy = { ...selectedQueues }
                                            delete copy[location.locationID]
